...
function CategoryAdd() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const validationErrors = categoryValidation(formData);
            ...
            <Container className='col-10 col-sm-6 p-3  rounded bg-secondary-subtle shadow_white'>
                ...
                <Form onSubmit={handleSubmit}>
                    <Form.Group className="mb-3" controlId="formGroupName">
                        ...
                        <Form.Control type="text" placeholder="Enter category name" name='categoryName' onChange={handleChange} />
                    ...
                    <Form.Group className="mb-3" controlId="formGroupCategoryType">
                        ...
                        <Form.Select value={formData.categoryType} name='categoryType' onChange={handleChange}>
                            <option value=''>Select category type</option>
                            <option value='accessory'>Accessory</option>
                            <option value='phone'>Phone</option>
                            <option value='repair part'>Repair part</option>
                        </Form.Select>
                        {errors.categoryType && <span className='text-danger'>{errors.categoryType}</span>}
                    </Form.Group>
